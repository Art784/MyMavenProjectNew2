...
public class MyTest3 {
    public static void main(String[] args) {
            ...
            WebElement webElement8 = driver.findElement(By.xpath("//a[@class='btn btn-orange ' and contains(@href,'/cart/add-product?id=A083673')]"));
            webElement8.click();
            WebElement webElement9 = driver.findElement(By.xpath("//div[@class='modal-content']//div[@class='modal-header']//button[@class='close modal-close']//i[@class='fa fa-times']"));
            // WebElement webElement9 = driver.findElement(By.xpath("//button[@class='close modal-close']//i[@class='fa fa-times']"));
            //WebElement webElement9 = driver.findElement(By.xpath("//button[@class='close modal-close']"));
            webElement9.click();
            //WebElement webElement10 = driver.findElement(By.xpath("//a[@class='btn btn-navy in-cart']"));
            //webElement10.click();
            WebElement webElement10 = driver.findElement(By.xpath("//a[@class='header__cart-img']"));
            webElement10.click();
            WebElement webElement11 = driver.findElement(By.xpath("//a[@class='js-delete']//i[@class='fa fa-trash-o']"));
            webElement11.click();
        //driver.quit();
    }
}
